...
SceneCmd spot07_room_1Set_cleansed[] = {
    SCENE_CMD_ECHO_SETTINGS(10),
    SCENE_CMD_ROOM_BEHAVIOR(0x00, 0x04, false, false),
    SCENE_CMD_SKYBOX_DISABLES(false, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&spot07_room_1RoomShapeCullable_000210),
    SCENE_CMD_OBJECT_LIST(8, spot07_room_1ObjectList_cleansed),
    SCENE_CMD_ACTOR_LIST(27, spot07_room_1ActorEntry_cleansed),
    SCENE_CMD_END(),
};

s16 spot07_room_1ObjectList_cleansed[] = {
    OBJECT_SPOT07_OBJECT,
    OBJECT_SYOKUDAI,
    OBJECT_KANBAN,
    OBJECT_TSUBO,
...
ActorEntry spot07_room_1ActorEntry_cleansed[] = {
    { ACTOR_EN_RIVER_SOUND, {   -189,     17,   -941 }, {      0,      0,      0 }, 0x0003 },
    { ACTOR_EN_ZO,          {   -786,     14,   -486 }, {      0, 0XFF4A,      0 }, 0xFFC0 },
    { ACTOR_EN_ZO,          {    841,     24,     39 }, {      0, 0XC7D2,      0 }, 0xFFC1 },
    { ACTOR_EN_ZO,          {    241,    -75,   -384 }, {      0, 0XF8E4,      0 }, 0xFFC2 },
