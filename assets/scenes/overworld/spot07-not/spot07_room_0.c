...
SceneCmd spot07_room_0Set_cleansed[] = {
    SCENE_CMD_ECHO_SETTINGS(10),
    SCENE_CMD_ROOM_BEHAVIOR(0x00, 0x04, false, false),
    SCENE_CMD_SKYBOX_DISABLES(false, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&spot07_room_0RoomShapeCullable_000150),
    SCENE_CMD_OBJECT_LIST(8, spot07_room_0ObjectList_cleansed),
    SCENE_CMD_ACTOR_LIST(13, spot07_room_0ActorEntry_cleansed),
    SCENE_CMD_END(),
};

s16 spot07_room_0ObjectList_cleansed[] = {
    OBJECT_SPOT07_OBJECT,
    OBJECT_SYOKUDAI,
    OBJECT_KANBAN,
    OBJECT_TSUBO,
...
ActorEntry spot07_room_0ActorEntry_cleansed[] = {
    { ACTOR_EN_RIVER_SOUND, {    642,    857,  -1691 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_EN_KZ,          {    628,    996,  -1780 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_BG_SPOT07_TAKI, {    445,   1008,  -1742 }, {      0,      0,      0 }, 0x0001 },
    { ACTOR_EN_A_OBJ,       {    345,    857,  -1572 }, {      0, 0X8000,      0 }, 0x2B0A },
