...
SceneCmd market_day_room_0Commands[] = {
    SCENE_CMD_ALTERNATE_HEADER_LIST(market_day_room_0AlternateHeaders),
...
SceneCmd* market_day_room_0AlternateHeaders[] = {
    NULL,
    market_day_room_0Set_adult,
    NULL,
};
...
SceneCmd market_day_room_0Set_adult[] = {
    SCENE_CMD_ECHO_SETTINGS(5),
    SCENE_CMD_ROOM_BEHAVIOR(0x00, 0x04, false, false),
    SCENE_CMD_SKYBOX_DISABLES(false, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&market_day_room_0RoomShapeNormal_0002D0),
    SCENE_CMD_OBJECT_LIST(15, market_day_room_0ObjectList_adult),
    SCENE_CMD_ACTOR_LIST(39, market_day_room_0ActorEntry_adult),
    SCENE_CMD_END(),
};

s16 market_day_room_0ObjectList_adult[] = {
    OBJECT_OS_ANIME,
    OBJECT_AOB,
    OBJECT_AHG,
    OBJECT_CNE,
...
ActorEntry market_day_room_0ActorEntry_adult[] = {
    { ACTOR_EN_HY,          {    289,      0,    488 }, {      0, 0X4000,      0 }, 0x0003 },
    { ACTOR_EN_HY,          {   -338,      2,     51 }, {      0, 0X5B06,      0 }, 0x0788 },
    { ACTOR_EN_HY,          {   -155,      0,   -287 }, {      0, 0X5A50,      0 }, 0x078B },
    { ACTOR_EN_TG,          {    132,      0,      0 }, {      0,      0,      0 }, 0x0000 },
