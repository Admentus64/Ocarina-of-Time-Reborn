...
SceneCmd enrui_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&enrui_room_0RoomShapeCullable_000550),
    SCENE_CMD_OBJECT_LIST(7, enrui_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(34, enrui_room_0ActorEntry_000064),
    SCENE_CMD_END(),
};
...
ActorEntry enrui_room_0ActorEntry_000064[] = {
...
u8 enrui_room_0padding_1[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
};

RoomShapeCullable enrui_room_0RoomShapeCullable_000550 = { 
    2, 15,
    enrui_room_0RoomShapeCullableEntry_00055C,
    enrui_room_0RoomShapeCullableEntry_00055C + ARRAY_COUNTU(enrui_room_0RoomShapeCullableEntry_00055C)
};

RoomShapeCullableEntry enrui_room_0RoomShapeCullableEntry_00055C[15] = {
    { {    611,    292,    -77 },    140, enrui_room_0DL_001DF8, NULL },
    { {   1074,    414,    -93 },    298, enrui_room_0DL_002440, NULL },
    { {    990,    395,  -1524 },    192, enrui_room_0DL_002A18, NULL },
    { {   1959,    253,   -220 },     82, enrui_room_0DL_002DA0, NULL },
    { {   2029,    247,  -1171 },     76, enrui_room_0DL_003160, NULL },
    { {   1265,    493,  -1944 },    450, enrui_room_0DL_003450, NULL },
    { {    401,    424,   -800 },    428, enrui_room_0DL_003838, NULL },
    { {  -2055,    135,   -401 },    614, NULL, enrui_room_0DL_004BA8 },
    { {   -108,    287,  -1330 },   4808, enrui_room_0DL_003B38, NULL },
    { {   5847,    575,   -482 },   1584, enrui_room_0DL_003DB0, NULL },
    { {   1254,    887,  -1174 },   6156, enrui_room_0DL_0013D8, NULL },
    { {   1361,    337,  -1032 },   1112, enrui_room_0DL_0018E0, NULL },
    { {  -1369,    220,  -1730 },   3762, enrui_room_0DL_0041E0, NULL },
    { {   -875,    170,  -1258 },   2546, enrui_room_0DL_0043C0, NULL },
};

s32 enrui_room_0_terminatorMaybe_00064C = { 0x01000000 };

Vtx enrui_room_0Vtx_000658[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_000658.vtx.inc"
};

Gfx enrui_room_0DL_0013D8[] = {
    gsSPVertex(&enrui_room_0Vtx_000658[208], 8, 0),
    ...
    gsDPLoadTLUT_pal16(15, enrui_sceneTLUT_008050),
    gsDPLoadTextureBlock_4b(enrui_sceneTex_004050, G_IM_FMT_CI, 32, 128, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR |  G_TX_WRAP, 5, 7, G_TX_NOLOD, G_TX_NOLOD),
    gsDPLoadTLUT_pal16(15, enrui_sceneTLUT_008050),
    gsDPLoadMultiBlock_4b(enrui_sceneTex_004050, 0x0000, 1, G_IM_FMT_CI, 32, 128, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 7, 1, 2),
    gsDPSetTileSize(1, 0x0012, 0x0005, 0x008E, 0x0201),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_000658, 32, 0),
    ...
    gsSPVertex(&enrui_room_0Vtx_000658[30], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&enrui_room_0Vtx_000658[61], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&enrui_room_0Vtx_000658[93], 32, 0),
    ...
    gsSPVertex(&enrui_room_0Vtx_000658[125], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&enrui_room_0Vtx_000658[155], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    ...
    gsSPVertex(&enrui_room_0Vtx_000658[185], 23, 0),
...
Vtx enrui_room_0Vtx_0017E0[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_0017E0.vtx.inc"
};

Gfx enrui_room_0DL_0018E0[] = {
    gsSPVertex(&enrui_room_0Vtx_0017E0[8], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, 0, TEXEL0, 0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal16(15, enrui_sceneTLUT_008070),
    gsDPLoadTextureBlock_4b(enrui_sceneTex_005050, G_IM_FMT_CI, 32, 128, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 7, G_TX_NOLOD, G_TX_NOLOD),
    gsDPLoadTLUT_pal16(15, enrui_sceneTLUT_008070),
    gsDPLoadMultiBlock_4b(enrui_sceneTex_005050, 0x0000, 1, G_IM_FMT_CI, 32, 128, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 7, 1, 2),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_0017E0, 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSPEndDisplayList(),
};

Vtx enrui_room_0Vtx_001A18[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_001A18.vtx.inc"
};

Gfx enrui_room_0DL_001DF8[] = {
    gsSPVertex(&enrui_room_0Vtx_001A18[26], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, 0, TEXEL0, 0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPLoadMultiBlock_4b(enrui_sceneTex_005050, 0x0000, 1, G_IM_FMT_CI, 32, 128, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 7, 1, 2),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_001A18, 26, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
...
Vtx enrui_room_0Vtx_001E08[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_001E08.vtx.inc"
};

Gfx enrui_room_0DL_002440[] = {
    gsSPVertex(&enrui_room_0Vtx_001E08[57], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, 0, TEXEL0, 0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPLoadMultiBlock_4b(enrui_sceneTex_005050, 0x0000, 1, G_IM_FMT_CI, 32, 128, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 7, 1, 2),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_001E08, 32, 0),
    ...
    gsSP1Triangle(26, 28, 29, 0),
    gsSPVertex(&enrui_room_0Vtx_001E08[30], 27, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Vtx enrui_room_0Vtx_002450[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_002450.vtx.inc"
};

Gfx enrui_room_0DL_002A18[] = {
    gsSPVertex(&enrui_room_0Vtx_002450[51], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, 0, TEXEL0, 0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPLoadMultiBlock_4b(enrui_sceneTex_005050, 0x0000, 1, G_IM_FMT_CI, 32, 128, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 7, 1, 2),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_002450, 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&enrui_room_0Vtx_002450[30], 21, 0),
...
Vtx enrui_room_0Vtx_002A28[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_002A28.vtx.inc"
};

Gfx enrui_room_0DL_002DA0[] = {
    gsSPVertex(&enrui_room_0Vtx_002A28[22], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, 0, TEXEL0, 0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPLoadMultiBlock_4b(enrui_sceneTex_005050, 0x0000, 1, G_IM_FMT_CI, 32, 128, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 7, 1, 2),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_002A28, 22, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Vtx enrui_room_0Vtx_002DB0[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_002DB0.vtx.inc"
};

Gfx enrui_room_0DL_003160[] = {
    gsSPVertex(&enrui_room_0Vtx_002DB0[25], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, 0, TEXEL0, 0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPLoadMultiBlock_4b(enrui_sceneTex_005050, 0x0000, 1, G_IM_FMT_CI, 32, 128, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 7, 1, 2),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_002DB0, 25, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Vtx enrui_room_0Vtx_003170[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_003170.vtx.inc"
};

Gfx enrui_room_0DL_003450[] = {
    gsSPVertex(&enrui_room_0Vtx_003170[13], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, 0, TEXEL0, 0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPLoadMultiBlock_4b(enrui_sceneTex_005050, 0x0000, 1, G_IM_FMT_CI, 32, 128, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 7, 1, 2),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_003170, 13, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 0, 2, 0),
...
Vtx enrui_room_0Vtx_003460[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_003460.vtx.inc"
};

Gfx enrui_room_0DL_003838[] = {
    gsSPVertex(&enrui_room_0Vtx_003460[25], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, 0, TEXEL0, 0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPLoadMultiBlock_4b(enrui_sceneTex_005050, 0x0000, 1, G_IM_FMT_CI, 32, 128, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 7, 1, 2),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_003460, 25, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Vtx enrui_room_0Vtx_003848[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_003848.vtx.inc"
};

Gfx enrui_room_0DL_003B38[] = {
    gsSPVertex(&enrui_room_0Vtx_003848[39], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    ...
    gsDPLoadTextureBlock_4b(enrui_sceneTex_005850, G_IM_FMT_I, 64, 64, 15, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 6, 6, 15, 15),
    gsDPLoadMultiBlock(enrui_sceneTex_004850, 0x0100, 1, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, 3, 4),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_003848, 32, 0),
    ...
    gsSPVertex(&enrui_room_0Vtx_003848[32], 7, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 1, 0),
    gsSP2Triangles(3, 5, 4, 0, 5, 6, 4, 0),
    gsSPEndDisplayList(),
};

Vtx enrui_room_0Vtx_003C80[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_003C80.vtx.inc"
};

Gfx enrui_room_0DL_003DB0[] = {
    gsSPVertex(&enrui_room_0Vtx_003C80[11], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPLoadMultiBlock(enrui_sceneTex_004850, 0x0100, 1, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, 3, 4),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_003C80, 11, 0),
...
Vtx enrui_room_0Vtx_004080[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_004080.vtx.inc"
};

Gfx enrui_room_0DL_0041E0[] = {
    gsSPVertex(&enrui_room_0Vtx_004080[14], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, 0, TEXEL0, 0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(enrui_sceneTex_007850, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_MIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, 1, G_TX_NOLOD),
    gsDPLoadMultiBlock(enrui_sceneTex_007050, 0x0100, 1, G_IM_FMT_IA, G_IM_SIZ_8b, 64, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 6, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_004080, 14, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 7, 8, 9, 0),
...
Vtx enrui_room_0Vtx_0042C0[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_0042C0.vtx.inc"
};

Gfx enrui_room_0DL_0043C0[] = {
    gsSPVertex(&enrui_room_0Vtx_0042C0[8], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    ...
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_XLU_DECAL2),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(enrui_sceneTex_007850, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, 1, G_TX_NOLOD),
    gsDPLoadMultiBlock(enrui_sceneTex_006850, 0x0100, 1, G_IM_FMT_IA, G_IM_SIZ_8b, 64, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_MIRROR | G_TX_WRAP, 6, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_0042C0, 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    gsSP2Triangles(4, 5, 6, 0, 7, 4, 6, 0),
    gsSPEndDisplayList(),
};

Vtx enrui_room_0Vtx_004518[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_004518.vtx.inc"
};

Vtx enrui_room_0Vtx_0048D8[] = {
#include "assets/scenes/misc/enrui/enrui_room_0Vtx_0048D8.vtx.inc"
};

Gfx enrui_room_0DL_004BA8_1[] = {
    gsSPVertex(&enrui_room_0Vtx_004518[32], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, 0, TEXEL0, 0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock_4b(enrui_sceneTex_003050, G_IM_FMT_I, 32, 128, 15, G_TX_MIRROR | G_TX_WRAP, G_TX_MIRROR | G_TX_WRAP, 5, 7, G_TX_NOLOD, G_TX_NOLOD),
    gsDPLoadMultiBlock(enrui_sceneTex_003850, 0x0100, 1, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, 15, 15),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_004518, 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
...
Gfx enrui_room_0DL_004BA8_2[] = {
    gsSPVertex(&enrui_room_0Vtx_0048D8[19], 8, 0),
    gsSPCullDisplayList(0, 7),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL1, 0, TEXEL0, 0, TEXEL1, TEXEL0, PRIM_LOD_FRAC, TEXEL0, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
    ...
    gsDPLoadMultiBlock(enrui_sceneTex_003850, 0x0100, 1, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 5, 5, 15, 15),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(enrui_room_0Vtx_0048D8, 19, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Gfx enrui_room_0DL_004BA8[] = {
    gsSPDisplayList(enrui_room_0DL_004BA8_1),
    gsSPDisplayList(enrui_room_0DL_004BA8_2),
    gsSPEndDisplayList(),
};
