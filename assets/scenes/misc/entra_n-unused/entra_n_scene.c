...
SceneCmd entra_n_sceneCommands[] = {
    SCENE_CMD_ALTERNATE_HEADER_LIST(market_entrance_night_sceneAlternateHeaders),
...
SceneCmd* market_entrance_night_sceneAlternateHeaders[] = {
    NULL,
    market_entrance_night_sceneSet_adult,
    NULL,
};
...
SceneCmd market_entrance_night_sceneSet_adult[] = {
    SCENE_CMD_SOUND_SETTINGS(0, 1, 127),
    SCENE_CMD_ROOM_LIST(1, market_entrance_night_sceneRoomList_adult),
    SCENE_CMD_TRANSITION_ACTOR_LIST(1, market_entrance_night_sceneTransitionActorList_adult),
    SCENE_CMD_MISC_SETTINGS(0x30, 0x0000000E),
    SCENE_CMD_COL_HEADER(&market_entrance_night_sceneCollisionHeader_adult),
    SCENE_CMD_ENTRANCE_LIST(market_entrance_night_sceneEntranceList_adult),
    SCENE_CMD_SPECIAL_FILES(NAVI_QUEST_HINTS_OVERWORLD, OBJECT_GAMEPLAY_FIELD_KEEP),
    SCENE_CMD_PATH_LIST(market_entrance_night_scenePathway_adult),
    SCENE_CMD_SPAWN_LIST(3, market_entrance_night_sceneStartPositionList_adult),
    SCENE_CMD_SKYBOX_SETTINGS(0, 0, true),
    SCENE_CMD_EXIT_LIST(market_entrance_night_sceneExitList_adult),
    SCENE_CMD_ENV_LIGHT_SETTINGS(1, market_entrance_night_sceneLightSettings_adult),
    SCENE_CMD_END(),
};

ActorEntry market_entrance_night_sceneStartPositionList_adult[] = {
    { ACTOR_PLAYER,     {      2,      0,   2147 }, {      0,      0,      0 }, 0x0F00 },
    { ACTOR_PLAYER,     {     11,      0,   2897 }, {      0, 0X8000,      0 }, 0x0F00 },
    { ACTOR_PLAYER,     {    154,      0,   2629 }, {      0, 0XC000,      0 }, 0x0E00 },
};

TransitionActorEntry market_entrance_night_sceneTransitionActorList_adult[] = {
    { 0, 255, 0, 255, ACTOR_EN_DOOR, 187, 0, 2630, -16384, 0x01BF },
};

RomFile market_entrance_night_sceneRoomList_adult[] = {
    { (uintptr_t)_entra_n_room_0SegmentRomStart, (uintptr_t)_entra_n_room_0SegmentRomEnd },
};

Spawn market_entrance_night_sceneEntranceList_adult[] = {
    { 0x00, 0x00 },
    { 0x01, 0x00 },
    { 0x02, 0x00 },
    { 0x00, 0x00 },
...
u16 market_entrance_night_sceneExitList_adult[] = {
    ENTR_MARKET_DAY_0,
    ENTR_HYRULE_FIELD_7,
    ENTR_MARKET_GUARD_HOUSE_0,
    ENTR_DEKU_TREE_0,
...
EnvLightSettings market_entrance_night_sceneLightSettings_adult[] = {
    { 0x1E, 0x1E, 0x1E, 0xD1, 0x66, 0x3A, 0xAA, 0xAA, 0x82, 0xA8, 0x55, 0xE0, 0xE6, 0xE6, 0xBE, 0x0A, 0x0A, 0x0A, 0x07E0, 0x07D0 },
};

Vec3s market_entrance_night_scenePathwayList_adult[] = {
    {    -12,      0,   2428 },
    {    -97,      0,   2487 },
    {   -102,      0,   2619 },
    {     -2,      0,   2651 },
...
Path market_entrance_night_scenePathway_adult[] = {
    { ARRAY_COUNT(market_entrance_night_scenePathwayList_adult), market_entrance_night_scenePathwayList_adult },
};

u8 entra_n_scene_possiblePadding_adult[] = {
    0x00, 0x00, 0x00, 0x00, 
};

Vec3s entra_n_sceneCollisionHeader_adultCamPosData[] = {
    {   -260,    820,   2200 },
    {  10923,  10012,      0 },
    {   4683,     -1,     -1 },
};

BgCamInfo market_entrance_night_sceneCollisionHeader_adultCamDataList[] = {
    { 0x0019, 3, &entra_n_sceneCollisionHeader_adultCamPosData[0] },
    { 0x0000, 0, NULL },
};

SurfaceType market_entrance_night_sceneCollisionHeader_adultSurfaceType[] = {
    {0x00000001, 0x00000FC2},   {0x00000301, 0x00000FC2},   {0x00000101, 0x00000FC2},
};

CollisionPoly market_entrance_night_sceneCollisionHeader_adultPolygons[] = {
    {0x0000, 0x0000, 0x0001, 0x0002, 0x0000, 0x0000, 0x8001, 0x0A64},
    {0x0000, 0x0000, 0x0002, 0x0003, 0x0000, 0x0000, 0x8001, 0x0A64},
    {0x0000, 0x0003, 0x0004, 0x0005, 0x8001, 0x0000, 0x0000, 0x0139},
    {0x0000, 0x0003, 0x0005, 0x0000, 0x8001, 0x0000, 0x0000, 0x0139},
...
Vec3s market_entrance_night_sceneCollisionHeader_adultVertices[] = {
    {    313,      0,   2660 },
    {    180,      0,   2660 },
    {    180,     80,   2660 },
    {    313,     80,   2660 },
...
CollisionHeader market_entrance_night_sceneCollisionHeader_adult = { 
    { -571, 0, 1860 },
    { 313, 520, 3060 },
    ARRAY_COUNT(market_entrance_night_sceneCollisionHeader_adultVertices), market_entrance_night_sceneCollisionHeader_adultVertices,
    ARRAY_COUNT(market_entrance_night_sceneCollisionHeader_adultPolygons), market_entrance_night_sceneCollisionHeader_adultPolygons,
    market_entrance_night_sceneCollisionHeader_adultSurfaceType,
    market_entrance_night_sceneCollisionHeader_adultCamDataList,
    0, NULL
};
