...
SceneCmd entra_n_room_0Commands[] = {
    SCENE_CMD_ALTERNATE_HEADER_LIST(market_entrance_night_room_0AlternateHeaders),
...
SceneCmd* market_entrance_night_room_0AlternateHeaders[] = {
    NULL,
    market_entrance_night_room_0Set_adult,
    NULL,
};
...
SceneCmd market_entrance_night_room_0Set_adult[] = {
    SCENE_CMD_ECHO_SETTINGS(5),
    SCENE_CMD_ROOM_BEHAVIOR(0x00, 0x04, false, false),
    SCENE_CMD_SKYBOX_DISABLES(false, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&market_entrance_night_room_0RoomShapeImageSingle_adult),
    SCENE_CMD_OBJECT_LIST(2, market_entrance_night_room_0ObjectList_adult),
    SCENE_CMD_ACTOR_LIST(2, market_entrance_night_room_0ActorEntry_adult),
    SCENE_CMD_END(),
};

s16 market_entrance_night_room_0ObjectList_adult[] = {
    OBJECT_SD,
    OBJECT_DOG,
};

ActorEntry market_entrance_night_room_0ActorEntry_adult[] = {
    { ACTOR_EN_HEISHI4, {    117,      0,   2824 }, {      0, 0XC000,      0 }, 0xFF08 },
    { ACTOR_EN_DOG,     {    -12,      0,   2428 }, {      0, 0XD8E4,      0 }, 0x0D00 },
};

u8 market_entrance_night_room_0_possiblePadding_1[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
};

RoomShapeImageSingle market_entrance_night_room_0RoomShapeImageSingle_adult = { 
    { 1, 1, &market_entrance_night_room_0RoomShapeDListsEntry_adult, }, 
    market_entrance_night_room_0Background_adult, 
    0x00000000, 0x00000000, 
    320, 240, 
    0, 2, 
    0x0000, 0x0000, 
...
RoomShapeDListsEntry market_entrance_night_room_0RoomShapeDListsEntry_adult = { 
    entra_n_room_0DL_000348, NULL
};
...
u64 market_entrance_night_room_0Background_adult[SCREEN_WIDTH * SCREEN_HEIGHT / 4] = {
